...
static       int centclientname     = 0;        /* 1 means active client name will be centered */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const double activeopacity   = 1.0f;     /* Window opacity when it's focused (0 <= opacity <= 1) */
static const double inactiveopacity = 1.0f; // 0.945f;   /* Window opacity when it's inactive (0 <= opacity <= 1) */
...
static const char col_cyan[]        = "#31758A"; // "#656e95"; 7b78ac 0a5b54 7170AB 03414e 31758A 428397 18A1A8 4C5AD4 2782de
...
static Key keys[] = {
	...
	// { MODKEY|ShiftMask,             XK_s, 	   spawn, 		   {.v = rect_screenshot} },
